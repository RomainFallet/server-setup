...
alias ss:recipes:ci-machine='bash ${serverSetupHomePath}/scripts/recipes/ci-machine/index.sh'
alias ss:recipes:ci-runner-machine='bash ${serverSetupHomePath}/scripts/recipes/ci-runner-machine/index.sh'"
